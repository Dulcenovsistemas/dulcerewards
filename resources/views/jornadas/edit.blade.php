...
<div class="relative max-w-7xl mx-auto py-6 px-4">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-4">
            ...
            <div class="bg-white/5 border border-white/10 rounded-2xl mt-4">

                <div class="p-4 border-b border-white/10">
                    <h2 class="text-white font-semibold">
                        Clientes registrados en esta jornada
                    </h2>
                </div>

                <div class="max-h-[40vh] overflow-y-auto">

                    @forelse($clientesJornada as $cliente)
                    ...
                    @empty
                        ...
                        <div class="p-6 text-center text-gray-400">
                            ...
                            No se han registrado clientes en esta jornada.
